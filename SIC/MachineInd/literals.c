...
void createLiteralTable()
{
        ...
        if (wordCount == 3)
        {
            ...
            if(operand[0] == '=')
            {
                 ...
                 if(operand[1]=='C')
                {
                    ...
                    for(i=3,c=0;operand[i]!='\0'&&c<3;i++,c++)
                    {
                                    fprintf(fp4,"%X",operand[i]);
                    }
                    //printf("%s\t%X\t%d\n",operand,LOCCTR,length-2);
                    fprintf(fp4,"\t%d\n",length-2);
                }
        ...
        else if(wordCount == 2)
        {
            ...
            if(operand[0] == '=')
            {
                ...
                if(operand[1]=='X')
                {
                    ...
                    for(i=3;i,i<strlen(operand)-1;i++)
                        fprintf(fp4,"%c",operand[i]);
                    fprintf(fp4,"\t%d\n",length-2);
                }
    ...
    printf("END of lietaral table 1!\n");
    fclose(fp1);
    fclose(fp2);
    fclose(fp3);
